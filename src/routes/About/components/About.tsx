            ...
            <div className=" about-container">
                ...
                <div className="body-section container" >
                    ...
                    <section className="container my-5">
                        ...
                        <p>Our research found that while many people are interested in contributing to open source, one of the biggest barriers to getting started was difficulty in finding an appropriate project that was a match for their skills, and abilities. This platform acts as a filtering system to help people overcome that initial obstacle and find a project that is right for them.</p>
                    </section>
                    <section className="container my-5">
                        <h3 className="about-sub-headings">How to use the platform?</h3>
                        <p>On the home page describe the programming languages you're comfortable using, once you put in a language, the site will ask you more about what kinds of issues you're looking for. It will then search the projects and surface issues that match your criteria. Give it a try!</p>
                    </section>
                </div>
                <FixMeFooter />
            </div>
